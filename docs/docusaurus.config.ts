...
const config: Config = {
  ...
  tagline: 'Infrahub Exporter is a service that exports metrics and service discovery',
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl: "https://github.com/opsmill/infrahub-exporter/tree/main/docs",
          routeBasePath: "/",
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        // },
        {
          href: "https://github.com/opsmill/infrahub-exporter",
          position: "right",
